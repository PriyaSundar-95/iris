...
# Input fields for the feature
sep_len = st.number_input("SepaLengthCm",min_value=0.0, step=0.1 , value=5.1)
sep_width = st.number_input("SepalWidthCm",min_value=0.0, step=0.1 , value=3.5)
pet_len = st.number_input("petalLengthCm",min_value=0.1, step=0.1 , value=1.4)
